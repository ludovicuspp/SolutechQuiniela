-- ============================================================
-- FIX URGENTE: Forzar actualización de place_bet en Supabase
-- Este script DROPs y re-crea la función limpia cualquier caché.
-- Ejecutar en Supabase SQL Editor (single execution)
-- ============================================================

-- Paso 1: Recrear get_bet_multiplier
...
-- Paso 2: Recrear place_bet (DROPeando primero para borrar cualquier versión vieja cacheada)
...
-- Paso 3: Verificar que la nueva versión está activa
-- Este SELECT debe devolver "cerró 10 minutos" si la función se actualizó bien
-- Si devuelve "12:00 PM" → la versión vieja sigue corriendo
